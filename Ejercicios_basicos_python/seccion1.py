...
print(f"hola mi nombre es {Name}, tengo {Edad} años, soy de {Ciudad} y soy {Profesion}")
# Una variable sirve para guardar un valor, y ese valor puede cambiar a lo largo del programa.
